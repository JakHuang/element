...
/* harmony default export */ var table_header = ({
                ...
                'th',
                {
                  ...
                  on: {
                    'mousemove': function mousemove($event) {
                      return _this.handleMouseMove($event, column, columns, cellIndex);
                    },
                    'mouseout': _this.handleMouseOut,
                    'mousedown': function mousedown($event) {
                      return _this.handleMouseDown($event, column, columns, cellIndex);
                    },
                    'click': function click($event) {
  ...
  methods: {
    ...
    handleMouseDown: function handleMouseDown(event, column, columns, cellIndex) {
      var _this2 = this;
    ...
    handleMouseMove: function handleMouseMove(event, column, columns, cellIndex) {
      if (column.children && column.children.length > 0) return;
      var target = event.target;
